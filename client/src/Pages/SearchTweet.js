...
function SearchTweet() {
	...
	return (
		<div className="container-fluid d-flex flex-column align-items-center justify-content-center bg-secondary">
			...
			>
				<div id="card-header" className="card-title row d-flex flex-wrap mb-0 g-0">
					<div className="col-sm-1 m-2 p-0 justify-content-center align-self-center">
						<img src={logo512} className="logo" alt="logo" />
					</div>

					{/* USER NAME  ----------------------------------------------------*/}
					<div
						className="col-sm-6 ps-3 pe-3 me-4 d-flex align-items-flex-start flex-nowrap"
						id="user-names"
					>
						<div>spiderman</div>
						<div>@spiderman</div>
					...
					<div id="icon-container" className="col-sm-4 pe-0 ms-1">
						<div className="row">
							#likes
